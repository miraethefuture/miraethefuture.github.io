var store = [{
        ...
        "title": "영단어 정리",
        "excerpt":"🗃️ A append to add something to a piece of writing. 글에 어떤 내용을 덧붙이다. 덧붙이다 첨부하다 allow to make something happen, especially something helpful or useful. 어떤일이 일어나는 것을 가능하게 만들다. automate to start using computers or machines to do a job, rather than people 어떤 일을 하기 위해...","categories": ["vocabularies","영어단어"],
